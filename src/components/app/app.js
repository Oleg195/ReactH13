...
class App extends Component {
  constructor(props){
    ...
    this.state={
      data: [
        {name:'КПО-204',salary: 8,rise:true, increase: false,id:1},
        {name:'КМФ-301',salary: 30, rise: false, increase: true,id:2},
        {name:'ИРМ-404',salary: 50, rise: false,increase: false,id:3}
      ],
      term:'',
      filter: "all"
...
switch(filter)
{
  ...
  case 'moreThen1000':
    return items.filter(item=>item.salary>25);
  default:
    return items
}
  }
